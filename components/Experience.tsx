        ...
        <div className='w-full px-6 md:px-12 xl:px-20 mt-40' id='exp'>
            ...
            <div className="relative max-w-4xl md:max-w-6xl lg:max-w-4xl mx-auto">
                ...
                <div 
                    ...
                    style={{ height: isMobile? 1020 : 890 }}
                >
                ...
                {/* first row */}
                {
                    workExperience.map((card, index) => (
                        <div 
                        key={card.id}
                        className={`relative flex items-center py-4 px-0 justify-center ${
                        ...
                        >
                            ...
                            <div className='px-6'>
                                ...
                                className='max-w-sm md:max-w-xs lg:max-w-sm text-white border-neutral-200 dark:border-slate-800 cursor-default'
                                >
                                    <div className='p-3 py-6 md:p-4 lg:p-6 gap-6'>
